            ...
            <div className={classes["info-heading--wrapper"]}>
              <h2 className={classes["info-heading"]}>
                ...
                <img
                  ...
                  src={logo}
                  alt="herbal solutions logo"
                />
              </h2>

              <Button className={classes["info-btn"]} onClick={closeInfoWindow}>
                &#x2715;
              </Button>
            </div>

            <p className={classes["info-text"]}>
              10 S Huron St. Ypsilanti Michigan , 48197
            </p>

            <a
              className={classes["marker-directions"]}
